...
const WelcomeAnimation = ({ userName, onComplete }) => {
  ...
  useEffect(() => {
    ...
    const timer5 = setTimeout(() => setShowConfiguration(true), 0);
    const timer6 = setTimeout(() => setShowConfiguration(false), 6000);
    const timer7 = setTimeout(() => setShowGift(true), 7000);
