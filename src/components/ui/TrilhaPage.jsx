    ...
    modules: [
      {
        ...
        title: 'Boas Vindas',
        lessons: [
          { id: 'boas-vindas-1', title: 'Boas Vindas', duration: '3:20', completed: false }
        ]
      },
      {
        id: 'introducao',
        title: 'Introdução',
        lessons: [
          { id: 'intro-1', title: 'O que é Autoconhecimento', duration: '5:45', completed: false },
          { id: 'intro-2', title: 'Importância na Carreira', duration: '4:30', completed: false }
        ]
      },
      {
        id: 'dominante',
        title: 'Dominante',
        lessons: [
          { id: 'dom-1', title: 'Características do Perfil D', duration: '6:15', completed: false },
          { id: 'dom-2', title: 'Aplicação no Agronegócio', duration: '7:20', completed: false }
        ]
      },
      {
        id: 'influente',
        title: 'Influente',
        lessons: [
          { id: 'inf-1', title: 'Características do Perfil I', duration: '5:50', completed: false },
          { id: 'inf-2', title: 'Liderança e Comunicação', duration: '6:40', completed: false }
        ]
      },
      {
        id: 'estavel',
        title: 'Estável',
        lessons: [
          { id: 'est-1', title: 'Características do Perfil S', duration: '5:30', completed: false },
          { id: 'est-2', title: 'Trabalho em Equipe', duration: '6:10', completed: false }
        ]
      },
      {
        id: 'conforme',
        title: 'Conforme',
        lessons: [
          { id: 'conf-1', title: 'Características do Perfil C', duration: '5:45', completed: false },
          { id: 'conf-2', title: 'Análise e Precisão', duration: '6:25', completed: false }
        ]
      },
      {
        id: 'encerramento',
        title: 'Encerramento',
        lessons: [
          { id: 'enc-1', title: 'Aplicando o Conhecimento', duration: '4:15', completed: false },
          { id: 'enc-2', title: 'Próximos Passos', duration: '3:45', completed: false }
        ]
      }
    ]
  };
                ...
                {activeTab === 'descricao' && (
                  <div className="text-gray-300">
                    <p className="leading-relaxed">
                      Bem-vindo à trilha de Autoconhecimento para Aceleração de Carreiras! 
                      Neste módulo introdutório, você conhecerá os objetivos do curso e como 
                      o autoconhecimento pode ser uma ferramenta poderosa para acelerar sua 
                      carreira no agronegócio.
                    </p>
                    <p className="mt-4 leading-relaxed">
                      Prepare-se para uma jornada de descobertas sobre seu perfil comportamental 
                      e como aplicar esse conhecimento para alcançar seus objetivos profissionais.
                    </p>
                  </div>
                )}
                {activeTab === 'comentarios' && (
                  ...
                  <div className="flex items-center justify-between p-4 bg-blue-900/20 border border-blue-800 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400">Conclua os módulos para liberar</p>
                      </div>
                    </div>
