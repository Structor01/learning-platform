            ...
            <CardContent className="space-y-6">
                    ...
                    <div className="p-4 border border-gray-200 rounded-lg bg-gray-50 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full min-h-[100px] p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                            />
                        </div>
                ...
                {experiencesList.length === 0 && !isAdding ? (
                    ...
                    experiencesList.map((exp) => (
                        <div key={exp.id} className="flex gap-4 pb-6 border-b border-gray-200 last:border-0 last:pb-0">
