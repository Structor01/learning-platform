            ...
            <CardContent className="space-y-4 md:space-y-6">
                    ...
                    <div className="p-4 border border-gray-200 rounded-lg bg-gray-50 space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full min-h-[80px] p-2 text-sm md:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 resize-none"
                            />
                        </div>
                ...
                {educationList.length === 0 && !isAdding ? (
                    <div className="text-center py-8">
                        ...
                        <p className="text-gray-500 text-sm md:text-base">Nenhuma formação adicionada</p>
                        <Button
                            onClick={() => setIsAdding(true)}
                    ...
                    educationList.map((edu) => (
                        <div key={edu.id} className="flex gap-3 md:gap-4 pb-4 md:pb-6 border-b border-gray-200 last:border-0 last:pb-0">
                            <div className="flex-shrink-0">
                                <div className="w-10 md:w-12 h-10 md:h-12 bg-green-50 rounded flex items-center justify-center">
                                    <GraduationCap className="w-5 md:w-6 h-5 md:h-6 text-green-600" />
                                </div>
                            </div>
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                                    <div className="min-w-0">
                                        ...
                                        {edu.grade && (
                                            <p className="text-xs md:text-sm text-gray-600">Nota: {edu.grade}</p>
                                        )}
                                        {edu.activities && (
                                            <p className="text-xs md:text-sm text-gray-600 mt-1">
